...
public record TrenchTraversal(TrenchType type, TraversalType traversal) implements RobotState {
  ...
  public Command getCommand(RobotContainer robotContainer) {
    ...
    // PointOfInterestManager.flipX(ChoreoVars.TrenchEnterX.in(Meters));
    //       case NEUTRAL_INTO_RED ->
    // PointOfInterestManager.flipX(ChoreoVars.TrenchExitX.in(Meters));
    //     };
    ...
    // return Commands.sequence(AutoBuilder.followPath(alignPath),
    // AutoBuilder.followPath(travelPath));
