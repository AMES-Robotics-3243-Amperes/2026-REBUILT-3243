...
public class GyroIOPigeon2 implements GyroIO {
  private final Pigeon2 pigeon =
      new Pigeon2(TunerConstants.DrivetrainConstants.Pigeon2Id, SwerveConstants.swerveCANBus);
  ...
  public GyroIOPigeon2() {
    ...
    yaw.setUpdateFrequency(SwerveConstants.odometryFrequency());
  ...
  public void updateInputs(GyroIOInputs inputs) {
    ...
    inputs.yawPosition = Rotation2d.fromRadians(yaw.getValue().in(Radians));
