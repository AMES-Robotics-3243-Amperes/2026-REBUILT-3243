...
public final class ChoreoVars {
    ...
    public static final class Poses {
        public static final Pose2d KeepOutBottom = new Pose2d(4.625467, 13.984986, Rotation2d.fromRadians(0));
        public static final Pose2d KeepOutTop = new Pose2d(4.625467, -5.91566, Rotation2d.fromRadians(0));
        public static final Pose2d SecondCenterCollectEnd = new Pose2d(6.14, 4.87, Rotation2d.fromRadians(-2));
        public static final Pose2d Shoot = new Pose2d(2.7916443, 7.207139, Rotation2d.fromRadians(-1.0490899));
        public static final Pose2d SitAndWait = new Pose2d(7.85, 7.42, Rotation2d.fromRadians(-1.5707963));
    }
}
// spotless:on
