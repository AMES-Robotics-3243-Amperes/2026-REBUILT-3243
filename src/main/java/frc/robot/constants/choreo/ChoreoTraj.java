...
public record ChoreoTraj(
  ...
  public static final ChoreoTraj SingleCollect =
      new ChoreoTraj(
          ...
          new Pose2d(4.46316, 7.628, Rotation2d.fromRadians(-1.5708)),
          new Pose2d(2.79164, 7.20714, Rotation2d.fromRadians(-1.04909)));
  public static final ChoreoTraj SingleCollect$0 =
      new ChoreoTraj(
          "SingleCollect",
          OptionalInt.of(0),
          2.86099,
  ...
  public static final ChoreoTraj SingleCollect$1 =
      new ChoreoTraj(
          "SingleCollect",
          OptionalInt.of(1),
          2.6248499999999995,
  ...
  public static final ChoreoTraj WaitThroughTrench =
      new ChoreoTraj(
          ...
          new Pose2d(7.85, 7.42, Rotation2d.fromRadians(-1.5708)),
          new Pose2d(2.79164, 7.20714, Rotation2d.fromRadians(-1.04909)));
  public static final ChoreoTraj WaitThroughTrench$0 =
      new ChoreoTraj(
          "WaitThroughTrench",
          OptionalInt.of(0),
          2.11612,
  ...
  public static final ChoreoTraj WaitThroughTrench$1 =
      new ChoreoTraj(
          "WaitThroughTrench",
          OptionalInt.of(1),
          2.6014399999999998,
