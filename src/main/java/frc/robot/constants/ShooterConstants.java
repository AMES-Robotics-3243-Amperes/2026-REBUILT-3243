...
public class ShooterConstants {
  ...
  public static final ControlConstantsBuilder flywheelControl =
      ControlConstantsBuilder.fromRadiansAndSeconds().pid(0.000023, 0, 0).sva(0, 0.0, 0.0);
  ...
  public static final ControlConstantsBuilder indexerControl =
      ControlConstantsBuilder.fromRadiansAndSeconds().pid(0.000065, 0, 0).sva(0, 0.0, 0.0);
